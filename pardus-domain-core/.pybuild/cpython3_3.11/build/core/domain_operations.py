...
from . import domain_joiner_ldap
...
def handle_winbind_join(domain, user, passwd):
    # TODO: winbind join operations will be added here
    # #
    # 1. krb5.conf düzenlenecek
    # 2. smb.conf düzenlenecek
    # 3. nsswitch.conf düzenlenecek
    # 4. kerberos ticket
    #   kinit Administrator@domain
    # 5. net ads join
    # 6. servis restart smbd nmbd winbind
    # 7. getent passwd user - domain kullanıcısı var mı? ##
    #
...
def leave(realmd=None, winbind=None):
    if realmd:
        ...
        # TODO: winbind leave operations will be added here
        pass
